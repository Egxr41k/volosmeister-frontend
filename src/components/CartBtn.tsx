...
export const CartBtn = () => {
    ...
    return <div className='flex justify-between relative w-full'>
        <NavBar/>
        <button className='bg-transparent border-none relative w-fit'
        ...
        <div className={['bg-white absolute right-0 shadow-md p-5 rounded-md z-10 top-14',
                !isShowCart ? "hidden" : ""].join(" ")}>
            {cartItems.map(item => (
